    ...
    <div>
        <div class="card mg-b-20">
            <div class="card-header pb-0">
                ...
                <p class="tx-12 tx-gray-500 mb-0">Car rental Lookup code...</p>
            </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body pt-2">  
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" v-model="codeForm.value">
                            </div>   
                            <div class="form-group">
...
<script>
export default {
    name: 'XpplAppCarRentCode',

    data() {
        return {
            cateData: [],
            codeData: [],
            codeForm: {id: '', category: '', code: '', value: '', descr: '', used: '1'},
            cateRowSel: '',
    ...
    methods: {
        async onLoad(){
            ...
            const cate = await axios.get('/api/carRent/category')
            this.cateData = cate.data;

            this.selectedCate(0, 'Car Type');
        ...
        refreshCode(){
            this.$axios.post('/api/carRent/code', {
        ...
        addCode(){
            this.$axios.post('/api/carRent/addcode', this.codeForm)
            .then((res) => {
                 if(res.data.success){
        ...
        updCode(){
            this.$axios.post('/api/carRent/updcode', this.codeForm)
            .then((res)=>{
            ...
            // } else {
                this.$swal.fire({
                    ...
                    if(result.isConfirmed){
                        this.$axios.post(`/api/carRent/delcode/${id}`)
                        .then((response)=>{
